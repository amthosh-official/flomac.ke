...
<div class="container-fluid">
    <form action="" id="insurance-form">
        ...
        <div class="form-group">
            ...
            <input type="date" name="expiration_date" id="expiration_date" class="form-control form-control-sm form-control-border" value ="<?php echo isset($expiration_date) ? $expiration_date : '' ?>" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label for="vehicle_model" class="control-label">CERT NO</label>
